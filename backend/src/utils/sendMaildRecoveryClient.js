const HTMLRecoveryPasswordEmail = (randomCode) => {
    return `
       <!DOCTYPE html>
  <html lang="es">
  <head>
                      ...
                      <tr>
                          <td style="padding-bottom: 30px;">
                              <p style="color: #555555; font-size: 15px; margin: 0; line-height: 1.5;">
                                  ...
                                  Ingresa el siguiente código de verificación en la aplicación para continuar.
                              </p>
                          </td>
                      </tr>
...
export default HTMLRecoveryPasswordEmail;
